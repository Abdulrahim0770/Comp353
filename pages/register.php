...
<html lang="en">
   ...
   <body id="register" class="animatedBg">
      <nav class="navbar navbar-expand-sm bg-warning navbar-light"> <!-- Nav bar-->
         <a class="navbar-brand" href="https://crc353.encs.concordia.ca">
      ...
      <div class ="container-fluid content">
         <div class="row">
            ...
            <div class="col-md-4 center-block registrationForm">
               ...
               <button onclick="location.href = 'https://crc353.encs.concordia.ca/';" class="btn btn-lg btn-primary btn-block" name="login">Login</button><br>
            </div>
            <div class="col-md-4 center-block"></div>
         </div>
      </div>
