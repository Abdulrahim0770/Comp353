...
<div class="container-fluid">
  ...
  <h1 style="color:purple;"> CLICK <a href="https://crc353.encs.concordia.ca/assets/debug.php" target="_blank"> >*>*>HERE<*<*< </a> TO VIEW ALL THE TABLES AND THEIR CONTENTS</h1>
  ...
  <?php
     ...
     while ($j < sizeof($table)) {
      ...
      $STHTHREE = $conn->query("SHOW FULL COLUMNS FROM $table[$j]");
